...
const looseDateFormats = ['ddd MMM DD YYYY HH:mm:ss ZZ',
// Tue May 15 2018 12:07:52 GMT-0400 (EDT)
'MMM DD, YYYY HH:mm:ss ZZ',
// May 15, 2018 12:07:52 -0400
'ddd, DD MMM YYYY HH:mm:ss ZZ' // Tue, 15 May 2018 16:07:52 GMT
];

const strictDateFormats = [_moment.default.RFC_2822, _moment.default.ISO_8601, 'YYYY-MM-DD hh:mm:ss a',
...
const transformObject = (o, fn) => {
  ...
  if (!(0, _isPlainObj.default)(o)) return fn(o)[0];
