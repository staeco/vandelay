...
describe('autoFormat.infer', () => {
  ...
  it('should parse dates', async () => {
    ...
    format.infer('5-15-2018').should.be.instanceof(Date)
    format.infer('2018-5-15').should.be.instanceof(Date)
    format.infer('5/2018').should.be.instanceof(Date)
    format.infer('February 3rd, 2014').should.be.instanceof(Date)
    format.infer('Feb 3, 2014').should.be.instanceof(Date)
    format.infer('February 3, 2014').should.be.instanceof(Date)
    format.infer('2016-01-01 11:31:23 PM').should.be.instanceof(Date)
    ...
    format.infer('R/1').should.eql('R/1')
    format.infer('1/2').should.eql('1/2')
    format.infer('1/2/3/4').should.eql('1/2/3/4')
  })
